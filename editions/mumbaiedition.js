...
square[1] = new Square("Gerald's Groceries", "$60", "#4B0082", 60, 3, 2, 10, 30, 90, 160, 250);
square[2] = new Square("Chance", "", "white");
...
square[7] = new Square("Chance", "", "white");
...
square[17] = new Square("Chance", "", "white");
...
square[22] = new Square("Retirement Home", "", "white");
...
square[27] = new Square("Ghandi Motel", "$260", "yellow", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("BEST Services", "$150", "white", 150, 2);
square[29] = new Square("Hilton", "$280", "yellow", 280, 8, 24, 120, 360, 850, 1025, 1200);
square[30] = new Square("", "", "white");
square[31] = new Square("New Street", "$300", "green", 300, 9, 26, 130, 390, 900, 110, 1275);
square[32] = new Square("Piramal Apt", "$300", "green", 300, 9, 26, 130, 390, 900, 110, 1275);
square[33] = new Square("Chance", "", "white");
...
square[36] = new Square("Chance", "", "white");
square[37] = new Square("Imperial I", "$350", "blue", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("Sanjana's Jewelery", "", "white");
